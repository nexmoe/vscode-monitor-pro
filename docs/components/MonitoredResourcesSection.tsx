      ...
      <div className="container px-4 md:px-6 space-y-16 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <ResourceItem
            icon="cpu"
            title="CPU 使用率"
            description="实时监控 CPU 使用情况"
          />
          <ResourceItem
            icon="activity"
            title="CPU 频率"
            description="跟踪 CPU 当前运行频率"
          />
          <ResourceItem
            icon="thermometer"
            title="CPU 温度"
            description="监控 CPU 温度变化"
          />
          <ResourceItem
            icon="database"
            title="内存使用"
            description="追踪系统内存消耗情况"
          />
          <ResourceItem
            icon="wifi"
            title="网络使用"
            description="监控网络流量和带宽使用"
          />
          <ResourceItem
            icon="hard-drive"
            title="磁盘使用"
            description="查看磁盘空间和读写速率"
          />
          <ResourceItem
          ...
          <ResourceItem
            icon="server"
            title="操作系统"
            description="显示当前操作系统信息"
          />
          <ResourceItem
            icon="clock"
            title="系统运行时间"
            description="记录系统持续运行的时间"
          />
        </div>
      </div>
    </section>
