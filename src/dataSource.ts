  ...
  async collect(prev: SystemSnapshot | null): Promise<SystemSnapshot> {
    ...
    return {
      ...
      battery: bat ? {
        ...
        health: bat.maxCapacity && bat.designedCapacity ? (bat.maxCapacity / bat.designedCapacity) * 100 : 0,
        powerRate: 0,
        powerState: bat.isCharging ? "charging" as const : bat.hasBattery ? ("discharging" as const) : ("none" as const),
        ...
        hasBattery: false, cycleCount: 0, isCharging: false, designedCapacity: 0,
        maxCapacity: 0, currentCapacity: 0, capacityUnit: "mWh", voltage: 0, percent: 0,
        health: 0, powerRate: 0, powerState: "none" as const,
        timeRemaining: 0, acConnected: false, type: "", model: "", manufacturer: "", serial: "",
      },
